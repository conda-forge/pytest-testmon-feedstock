About pytest-testmon-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-testmon-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/tarpas/pytest-testmon/

Documentation: https://pypi.python.org/pypi/pytest-testmon
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3299&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-testmon-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-testmon` can be installed with `conda`:
...
```
mamba install pytest-testmon
```

It is possible to list all of the versions of `pytest-testmon` available on your platform with `conda`:
...
```
mamba search pytest-testmon --channel conda-forge
```
...
mamba repoquery search pytest-testmon --channel conda-forge

# List packages depending on `pytest-testmon`:
mamba repoquery whoneeds pytest-testmon --channel conda-forge

# List dependencies of `pytest-testmon`:
mamba repoquery depends pytest-testmon --channel conda-forge
```
